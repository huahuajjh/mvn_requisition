...
//		sb.append("select new com.tqmars.requisition.presentation.dto.sysMgt.AccountSafeDto(a.id,a.account,a.name,a.deptId,d.deptName,a.orgId,o.orgName,a.roleId,r.roleName,a.state)");
