...
public class TransferAddQuerySpecification extends Specification<TransferHouseholdInfo>{
	...
	public IHqlExpression getHqlExpression() {
		...
		sb.append("select new com.tqmars.requisition.presentation.dto.transferMgt.TransferInfo4AddDto(f.name,f.proName,f.householdStr,f.address,f.idNumber,f.proId,f.id) from FamilyItem f");
