...
public class HPTUseTableSpecification extends Specification<HousePuraseTicket>{
	...
	public IHqlExpression getHqlExpression() {
		...
		sb.append("select new com.tqmars.requisition.presentation.dto.hpt.HPTUseTableDto(fi.proId,fi.proName,fi.idNumber,fi.name,fi.id,h.id,h.ticketNumber,h.bonus,u.usingDate,u.usingType,u.usingToWhere,u.situationExplain,u.evidencePath,h.makeDate)");
