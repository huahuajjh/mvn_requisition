...
public class TransferQueryFuzzySpecifiaction extends Specification<TransferHouseholdInfo>{
	...
	public IHqlExpression getHqlExpression() {
		...
		sb.append("select new com.tqmars.requisition.presentation.dto.transferMgt.TransferInfoDto4Table(f.proId,f.proName,f.name,f.idNumber,f.householdStr,t.transferDate,t.address,f.id,t.id,f.householdId,");
