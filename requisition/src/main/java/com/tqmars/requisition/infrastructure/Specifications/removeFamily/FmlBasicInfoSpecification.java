...
public class FmlBasicInfoSpecification extends Specification<Family>{
	...
	public IHqlExpression getHqlExpression() {
		...
		sb.append("select new com.tqmars.requisition.presentation.dto.rmHousehold.FamilyBasicInfoDto(f.headName,fi.idNumber,fi.proName,fi.address,f.streetId,f.communityId,f.groupId,f.proId,fi.fmlId)");
