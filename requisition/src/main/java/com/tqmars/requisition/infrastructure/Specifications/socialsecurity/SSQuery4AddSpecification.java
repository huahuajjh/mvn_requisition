...
public class SSQuery4AddSpecification extends Specification<SocialsecurityInfo>{
	...
	public IHqlExpression getHqlExpression() {
		...
		sb.append("select new com.tqmars.requisition.presentation.dto.socialsecurityMgt.Socialsecurity4AddDto(f.proId,f.id,f.proName,f.name,f.idNumber,f.birthday)");
