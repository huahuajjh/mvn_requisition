...
public class SSQueryFuzzySpecification extends Specification<SocialsecurityInfo>{
	...
	public IHqlExpression getHqlExpression() {
		...
		sb.append("select new com.tqmars.requisition.presentation.dto.socialsecurityMgt.SocialsecurityDto(s.id,f.proId,f.proName,f.name,f.idNumber,'',s.socialsecurityDate,f.id,s.serveArmyTime,s.endowmentInsuranceYear,s.medicalInsuranceMonth,s.joinWhichMedicalInsurance,s.community,s.prisonTime,s.socialsecurityTypeId)");
