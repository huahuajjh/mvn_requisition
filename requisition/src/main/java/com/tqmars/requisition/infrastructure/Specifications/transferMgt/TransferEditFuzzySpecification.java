...
public class TransferEditFuzzySpecification extends Specification<TransferHouseholdInfo>{
	...
	public IHqlExpression getHqlExpression() {
		...
		//express
		sb.append("select new com.tqmars.requisition.presentation.dto.transferMgt.EditQueryTransferDto(t.id,f.name,f.idNumber,f.householdId,t.streetId,t.communityId,t.transferDate)");
